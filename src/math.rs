...
pub fn lerpf(a: f32, b: f32, f: f32) -> f32 { a + f * (b - a) }
...
pub fn vec2_zeroish(v: Vec2) -> bool { near_zero(v.x()) && near_zero(v.y()) }

pub fn vec2_nearly(a: Vec2, b: Vec2) -> bool { vec2_zeroish(a - b) }
